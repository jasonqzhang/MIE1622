...
plot(1:N_days,portf_value{1,1},1:N_days,portf_value{1,2},1:N_days,portf_value{1,3},1:N_days,portf_value{1,4},1:N_days,portf_value{1,5},1:N_days,portf_value{1,6}-init_value,1:N_days,portf_value{1,7});
title('Performance of Strategies for 2008 and 2009');
